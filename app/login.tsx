...
const styles = StyleSheet.create({
  ...
  esqueceuSenha2: { fontWeight: "bold", color: "#042b00" },
  containerBotao: { justifyContent: "center", alignItems: "center", marginTop: 20 },
  botao: { justifyContent: "center", alignItems: "center", borderWidth: 1, borderColor: "#042b00", marginBottom: 15, width: 200, height: 45, borderRadius: 20, backgroundColor: "#042b00" },
