...
const styles = StyleSheet.create({
  ...
  fieldBox: { flexDirection: "row", alignItems: "center", backgroundColor: "#f5f5f5", borderRadius: 15, borderWidth: 1, borderColor: "#1b5e20", paddingHorizontal: 12, paddingVertical: 14, marginBottom: 12 },
  fieldText: { flex: 1, marginLeft: 10, fontSize: 17, color: "#042b00" },
  updateButton: { backgroundColor: "#1b5e20", paddingVertical: 12, paddingHorizontal: 50, borderRadius: 20, marginTop: 20, alignItems: "center" },
  updateButtonText: { color: "#fff", fontSize: 17, fontWeight: "bold" },
  badge: { position: "absolute", top: -3, right: -3, backgroundColor: "#d32f2f", width: 18, height: 18, borderRadius: 20, justifyContent: "center", alignItems: "center" },
  ...
  modalBox: { width: "85%", backgroundColor: "#fff", padding: 20, borderRadius: 20 },
  modalTitle: { fontSize: 20, fontWeight: "bold", textAlign: "center", marginBottom: 10 },
  notificacaoItem: { flexDirection: "row", padding: 12, backgroundColor: "#eee", borderRadius: 12, marginBottom: 10 },
  modalButton: { backgroundColor: "#1b5e20", paddingVertical: 10, paddingHorizontal: 25, borderRadius: 15, alignSelf: "center", marginTop: 10 },
